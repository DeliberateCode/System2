...
class ArgOrderingDeterminismTest(unittest.TestCase):
    """Composition is independent of CLI overlay ordering."""
    ...
    def test_ir_ordered_contributions_identical_under_reorder(self):
        ...
        self.assertEqual(
            ...
            msg=(
                ...
                "reversed; the front-end (overlay_name, id) pre-sort must make "
        ...
        for ln in diff_ab:
            self.assertTrue(
                ...
                msg=(
                    ...
                    f"line: {ln!r} — this would be a real ordering regression"
                ),
            )
...
class AnchorExclusionTest(unittest.TestCase):
    """Check anchor identity and non-existent-anchor exclusion."""
        ...
        for other in other_agents:
            self.assertIsNone(
                ...
                msg=(
                    ...
                    f"resolve on agent {other!r}; anchor identity is scoped per agent"
                ),
            )
