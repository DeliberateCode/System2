<!-- COMPOSED: system2 + overlays: anchorfile@1.0.0 -->
<!-- Composed at: 2026-06-27T00:22:48Z -->
...
### executor
- **implementation_discipline** (from anchorfile): Known-anchor guidance for the executor's implementation discipline. Full guidance: read `.system2/overlays/anchorfile/contributions/known.md`.
