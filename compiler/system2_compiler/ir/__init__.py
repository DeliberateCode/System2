...
package imports no backend (the requirement/013/040). ``compose`` orchestrates
...
def _compute_files_to_write(
    ...
    is the backend's job (the implementation work); this is the dry-run-safe intent list."""
    files_to_write = [
