...
- Do not embed planning-artifact identifiers in production code comments or docstrings. Traceability lives in specifications and git history, not in code annotations that go stale on first refactor.
