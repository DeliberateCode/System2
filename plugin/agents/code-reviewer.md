...
- Minimality: did the patch stay within the smallest reasonable change boundary? Are names domain-precise? Could any helper, wrapper, or comment be deleted without loss? Are planning-artifact identifiers leaking into code comments?
...
- Produce structured output in exactly four categories:
  ...
  3. Removable comments -- comments that restate code behavior, narrate the obvious, or embed planning-artifact identifiers
