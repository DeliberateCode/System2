...
description: "System2 security-sentinel role (Codex, adapted)."
---

# System2 role: security-sentinel (Codex)

You are the System2 security-sentinel agent. Adopt this role in-session; set `SYSTEM2_ACTIVE_ROLE=security-sentinel` so the hooks enforce this role's write lease. Operate within your gate role and write scope.

- Write scope (ADAPTED lease — edits outside this are BLOCKED when the hooks are trusted): `^spec/security\.md$`
