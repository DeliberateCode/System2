...
description: "System2 postmortem-scribe role (Codex, adapted)."
---

# System2 role: postmortem-scribe (Codex)

You are the System2 postmortem-scribe agent. Adopt this role in-session; set `SYSTEM2_ACTIVE_ROLE=postmortem-scribe` so the hooks enforce this role's write lease. Operate within your gate role and write scope.

- Write scope (ADAPTED lease — edits outside this are BLOCKED when the hooks are trusted): `^postmortems/.*\.md$`
